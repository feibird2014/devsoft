...
function getGruntTasks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!(yield exists(path.join(workspaceRoot, 'gruntfile.js'))) && !(yield exists(path.join(workspaceRoot, 'Gruntfile.js')))) {
            return emptyTasks;
        }
        let command;
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/27492b6bf3acb0775d82d2f87b25a93490673c6d/extensions\grunt\out/main.js.map
